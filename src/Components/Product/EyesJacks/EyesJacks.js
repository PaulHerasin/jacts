...
import Creepy from './Eyes_Creepy.gif'
import Crosses from './Eyes_Crosses.gif'
import Cry from './Eyes_Cry.gif'
import Cute from './Eyes_Cute.gif'
import Cyclops from './Eyes_Cyclops.gif'
import Died from './Eyes_Died.gif'
import Disapproving from './Eyes_Disapproving.gif'
import Disgruntled from './Eyes_Disgruntled.gif'
import Disgust from './Eyes_Disgust.gif'
import Dread from './Eyes_Dread.gif'
import EvilJackEyes from './Eyes_Evil Jack Eyes.gif'
import EvilMonster from './Eyes_Evil Monster.gif'
import EvilSquint from './Eyes_Evil Squint.gif'
import Evil from './Eyes_Evil.gif'
import Focused from './Eyes_Focused.gif'
import FrowningEyebrows from './Eyes_Frowning Eyebrows.gif'
import Furious from './Eyes_Furious.gif'
import HappyU from './Eyes_Happy U.gif'
...
import Mystical from './Eyes_Mystical.gif'
import Nice from './Eyes_Nice.gif'
import OpenGlaze from './Eyes_Open Glaze.gif'
import Pacifying from './Eyes_Pacifying.gif'
import Potter from './Eyes_Potter.gif'
import SadJack from './Eyes_Sad Jack.gif'
import ScaryCat from './Eyes_Scary Cat.gif'
import Skeptical from './Eyes_Skeptical.gif'
import Sleepy from './Eyes_Sleepy.gif'
import Sonic from './Eyes_Sonic.gif'
import SpiderEyes from './Eyes_Spider Eyes.gif'
import Square from './Eyes_Square.gif'
import Squints from './Eyes_Squints.gif'
import Stars from './Eyes_Stars.gif'
import Surprised from './Eyes_Surprised.gif'
import Tired from './Eyes_Tired.gif'
import Upset from './Eyes_Upset.gif'
import Wormhole from './Eyes_Wormhole.gif'
        ...
        <div className="product__body-box">
          ...
          <div className="product__body-scroll">
            <div className="product__body-list">
              ...
              <div className="product__item">
                <div className="product__item-title">Cute</div>
                <div className="product__item-img img-wrap">
                  <div><img src={Cute} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
              ...
              <div className="product__item">
                <div className="product__item-title">Evil Jack Eyes</div>
                <div className="product__item-img img-wrap">
                  <div><img src={EvilJackEyes} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
                <div className="product__item-title">Evil Monster</div>
                <div className="product__item-img img-wrap">
                  <div><img src={EvilMonster} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
        ...
        <div className="product__body-box">
          ...
          <div className="product__body-scroll">
            <div className="product__body-list">
              ...
              <div className="product__item">
                <div className="product__item-title">Furious</div>
                <div className="product__item-img img-wrap">
                  <div><img src={Furious} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
                <div className="product__item-title">Happy U</div>
                <div className="product__item-img img-wrap">
                  <div><img src={HappyU} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
                <div className="product__item-title">Happy V</div>
                <div className="product__item-img img-wrap">
                  <div><img src={HappyV} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
              ...
              <div className="product__item">
                <div className="product__item-title">Monster</div>
                <div className="product__item-img img-wrap">
                  <div><img src={Monster} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
              ...
              <div className="product__item">
                <div className="product__item-title">Squints</div>
                <div className="product__item-img img-wrap">
                  <div><img src={Squints} alt="" /></div>
                </div>
              </div>
              <div className="product__item">
                <div className="product__item-title">Stars</div>
                <div className="product__item-img img-wrap">
